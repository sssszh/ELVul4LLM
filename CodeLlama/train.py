...
def run_training(args, train_data, val_data):
    ...
    model = LlamaForSequenceClassification.from_pretrained(model_path, quantization_config=q_config, device_map={"": Accelerator().process_index}, pad_token_id=tokenizer.eos_token_id, num_labels=args.num_labels)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--db', default=True, action='store_true', help='set to turn on debug mode i.e. using dummy small data split and only 1 data worker')
    ...
    parser.add_argument('--save-freq', default=2, type=int, help='save model checkpoints after this number of training steps')
