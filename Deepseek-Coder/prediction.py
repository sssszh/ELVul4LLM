...
eval_dataloader = DataLoader(eval_dataset, sampler=eval_sampler, batch_size=4, num_workers=8)
...
model = AutoModelForSequenceClassification.from_pretrained(args.model_path, device_map="auto", quantization_config=q_config, config=config)
# model = AutoModelForSequenceClassification.from_pretrained(args.model_path, device_map="auto", torch_dtype=torch.bfloat16, pad_token_id=tokenizer.eos_token_id)
