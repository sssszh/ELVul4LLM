...
model = AutoModelForSequenceClassification.from_pretrained(args.model_path, device_map="auto", quantization_config=q_config, pad_token_id=tokenizer.eos_token_id, num_labels=args.num_labels)
